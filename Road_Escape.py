        ...
        for hand_mark in result.multi_hand_landmarks:
            ...
            for i in range(8, 21, 4):
                if lmlist[i][3] > lmlist[i-2][3]:    # Counting Number of fingers Shown
                    fingers+=1
    cv2.putText(frame, "Join the Index Finger", (250,30), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 2)
    cv2.putText(frame, "and Thumb to Start", (270,55), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 2)
